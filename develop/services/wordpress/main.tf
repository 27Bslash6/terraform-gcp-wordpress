...
#
# output "cloudsql_master_ip" {
#   value = "${module.cloudsql.module.google_sql_database_instance.master.ip}"
# }

module "redis" {
  # source = "git::https://github.com/27Bslash6/terraform-gke.git?ref=0.0.3"
